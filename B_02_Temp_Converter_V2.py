...
class Converter:
    ...
    def __init__(self):
        ...
        button_details_list = [
            ...
            ["Help / Info", "#019E95", self.to_help, 1, 0],
            ["History / Export", "#05668D", self.to_history, 1, 1]
        ]
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        help_text = "To use the program, simply enter the temperature" \
                    ...
                    "(-459 F) is absolute zero (coldest possible " \
                    "temperature). If you try to convert a " \
                    "temperature that is less than -273 degrees C, " \
                    "you will get an error message. \n\n" \
                    "to see your" \
                    "calculation history and export button it to a text " \
